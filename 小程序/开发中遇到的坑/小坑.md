...
1.1 在父组件json中导入子组件
 ...
 ![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815145634086-821986996.jpg)

1.2 在子组件的json中，把自己定义为子组件

![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815151448106-478710811.jpg)

 

\2. 在父组件中，子组件的引用处，绑定一个属性( text )，并传递想要给子组件的值( parentParam )

![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815150640854-152458379.jpg)

 

\3. 在子组件中的js中使用 properties 获取值，这样就可以在子组件中用 this.data.text 获取到这个值了

![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815145651657-1637360548.jpg)
...
![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815150354672-1217091782.jpg)

 

\2. 在父组件中，子组件的引用处，通过这个myevent事件绑定一个方法( onMyEvent )

![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815150405083-236858031.png)

 

\3. 在父组件的js中，定义这个方法onMyEvent，在这个方法内就可以获取到子组件传递过来的值了

![img](D:\文章\小程序\开发中遇到的坑\1689273-20190815150533642-351519028.jpg)
...
![image-20200509113346748](D:\文章\小程序\开发中遇到的坑\image-20200509113346748.png)

![image-20200509112946981](D:\文章\小程序\开发中遇到的坑\image-20200509112946981.png)



#### 5，在页面调用自定义组件中的方法

![image-20200519092639761](D:\文章\小程序\开发中遇到的坑\image-20200519092639761.png)

detail页面中引用了w-attr-info自定义组件

现在需要调用其

![image-20200519092743990](D:\文章\小程序\开发中遇到的坑\image-20200519092743990.png)
...
![image-20200519094533817](D:\文章\小程序\开发中遇到的坑\image-20200519094533817.png)

在js中取到这个组件，然后执行其方法即可

![image-20200519095014543](D:\文章\小程序\开发中遇到的坑\image-20200519095014543.png)
